 ...
 */
final class Version20240221102912 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE members (  id INT AUTO_INCREMENT NOT NULL,         firstname VARCHAR(25) NOT NULL,            lastname VARCHAR(25) NOT NULL,
        ...
        $this->addSql("INSERT INTO members (firstname, lastname, role, img, link, description) VALUES 
